		...
		<div class="container marg">
			<div class="row">
				<div class="col-4 mb-4">
					<img src="img/hero-1.jpg" class="img-fluid rounded" alt="..." />
				</div>
				<div class="col-4">
					<img src="img/hero-2.jpg" class="img-fluid rounded" alt="..." />
				</div>
				<div class="col-4">
					<img src="img/hero-3.jpg" class="img-fluid rounded" alt="..." />
				</div>
				<div class="col-4">
					<img src="img/hero-4.jpg" class="img-fluid rounded" alt="..." />
				</div>
			</div>
		</div>
